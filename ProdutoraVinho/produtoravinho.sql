...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/06/2024 às 17:41
...
(1, 'Mata', 'Grossa', '685423147', 'valmiro@mail.telepac.pt', 1),
(3, 'Galo', 'Careca', '652309270', 'esporao@esporao.com', 2),
(4, 'Uganda', NULL, NULL, NULL, 3),
(5, 'Dão Botão', NULL, NULL, NULL, 3),
(6, 'Moçamba', NULL, NULL, NULL, 1),
(7, 'Dão Bibão', NULL, NULL, NULL, 2),
(8, 'Dão Norte', NULL, NULL, NULL, 5),
(9, 'Dão João', NULL, NULL, NULL, 1);
...
--
ALTER TABLE `produtor`
  MODIFY `produtorid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
